...
function Stats() {
    return (
        <div className='container '>
            ...
            <div>
                <a href='https://google.com' style={{textDecoration: "none"}}>Explore our products                <i class="fa-solid fa-arrow-right" style={{color: "blue"}}></i> &nbsp; &nbsp;
</a>&nbsp;
                <a href='https://kite.zerodha.com' style={{textDecoration: "none"}}>Try Kite demo                <i class="fa-solid fa-arrow-right" style={{color: "blue"}}></i> &nbsp; &nbsp;
</a>
            </div>
            </div>
            </div>
